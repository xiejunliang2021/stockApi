    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=22, verbose_name="地区名称")),
                ("level", models.CharField(max_length=3, verbose_name="区域等级")),
            ],
            options={
                "verbose_name": "地区表",
                "db_table": "area",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_default",
                    models.BooleanField(default=False, verbose_name="是否为默认收获地址"),
                ),
                (
                    "user",
                    models.ForeignKey(
